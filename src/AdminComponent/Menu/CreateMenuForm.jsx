...
import { IconButton, CircularProgress, Grid, FormControl, InputLabel, Select, OutlinedInput, Box  } from '@mui/material';
...
const CreateMenuForm = () => {
  ...
  return (
    <div className='py-10 px-5 lg:flex items-center justify-center min-h-screen'>
        ...
        >
          {["bread","cream"].map((name,index) => (
            ...
            >
             ...
             <Grid item xs={12} lg={6}>
              <FormControl fullWidth>
                <InputLabel id="demo-simple-select-label">Is Magaron</InputLabel>
                <Select
                labelId="demo-simple-select-label"
                id="magaron"
                value={formik.values.magaron}
                label="Is Seasionally"
                onChange={formik.handleChange}
                name="magaron"
            >
                <MenuItem value={true}>Yes</MenuItem>
        ...
        type="submit">Create Menu</Button>
        </form>
        </div>
    </div>
  );
