export const CREATE_RESTAURANT_REQUIEST = "CREATE_RESTAURANT_REQUIEST";
...
export const GET_ALL_RESTAURANT_REQUIEST = "GET_ALL_RESTAURANT_REQUIEST";
...
export const DELETE_RESTAURANT_REQUIEST = "DELETE_RESTAURANT_REQUIEST";
...
export const UPDATE_RESTAURANT_REQUIEST = "UPDATE_RESTAURANT_REQUIEST";
...
export const GET_RESTAURANT_BY_USER_REQUEST = "GET_RESTAURANT_BY_USER_REQUEST";
export const GET_RESTAURANT_BY_USER_SUCCESS = "GET_RESTAURANT_BY_USER_SUCCESS";
export const GET_RESTAURANT_BY_USER_FAILURE = "GET_RESTAURANT_BY_USER_FAILURE" ;
...
export const CREATE_ALL_EVENTS_REQUEST = "CREATE_ALL_EVENTS_REQUEST";
export const CREATE_ALL_EVENTS_SUCCESS = "CREATE_ALL_EVENTS_SUCCESS";
export const CREATE_ALL_EVENTS_FAILURE = "CREATE_ALL_EVENTS_FAILURE" ;

export const GET_ALL_CREATE_EVENTS_REQUEST = "GET_ALL_CREATE_EVENTS_REQUEST";
export const GET_ALL_CREATE_EVENTS_SUCCESS = "GET_ALL_CREATE_EVENTS_SUCCESS";
export const GET_ALL_CREATE_EVENTS_FAILURE = "GET_ALL_CREATE_EVENTS_FAILURE" ;
...
export const GET_RESTAIRANTS_EVENTS_REQUEST = "GET_RESTAIRANTS_EVENTS_REQUES";
